...
When you use this code, the Palette interface provided by Material-UI is augmented with your custom neutral property, allowing you to use it in your theme object without TypeScript throwing an error. */
